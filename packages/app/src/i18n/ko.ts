export const dict = {
  ...
  "settings.general.row.magiExecutorModel.title": "고성능 코딩 모델",
  "settings.general.row.magiExecutorModel.description": "Magi가 구현, 복잡한 설계, 큰 코드 변경에 사용하는 외부 모델",
  "settings.general.row.magiCouncilModel.title": "로컬 council 모델",
  "settings.general.row.magiCouncilModel.description": "MELCHIOR, BALTHASAR, CASPER council 멤버가 사용하는 LM Studio 모델",
  "settings.general.row.magiCouncilFallbacks.title": "Council fallback 모델",
  "settings.general.row.magiCouncilFallbacks.description": "주 council 모델 실패 시 순서대로 시도할 쉼표 구분 모델 ID",
  "settings.general.row.magiSelfImprovement.title": "Self Improvement",
  "settings.general.row.magiSelfImprovement.description": "Magi가 다수결로 승인된 개선 작업을 계속 제안하고 실행하도록 허용",
  "settings.general.row.magiCoreSelfEdit.title": "Core self-edit 정책",
  "settings.general.row.magiCoreSelfEdit.description": "disabled, gated, allowed 중 하나. gated core edit은 제안만 하고 자동 실행하지 않습니다.",
  "settings.general.row.magiSelfImprovementInterval.title": "Self Improvement 주기",
  "settings.general.row.magiSelfImprovementInterval.description": "활성화된 동안 UI가 Magi self-improvement cycle을 실행하는 분 단위 주기",
  "settings.general.row.magiMaxCycles.title": "Self Improvement 최대 cycle",
  "settings.general.row.magiMaxCycles.description": "한 번 시작된 Self Improvement 루프가 실행할 최대 자동 cycle 수",
  "magi.selfImprovement.toggle.on": "Self Improvement: 켜짐",
  "magi.selfImprovement.toggle.off": "Self Improvement: 꺼짐",
  "magi.selfImprovement.toggle.paused": "Self Improvement: 일시정지",
  "magi.selfImprovement.toast.on.title": "Self Improvement 활성화됨",
  "magi.selfImprovement.toast.on.description": "Magi가 다수결로 승인된 개선 작업을 만들 수 있습니다.",
  "magi.selfImprovement.toast.off.title": "Self Improvement 비활성화됨",
  "magi.selfImprovement.toast.off.description": "Magi는 리뷰만 수행하고 개선 작업은 시작하지 않습니다.",
