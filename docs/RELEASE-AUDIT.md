...
**실제 LLM 후속 시험:** OpenRouter 무료 모델을 실제 OpenCode에 연결한 [별도 검증 결과](REAL-MODEL-AUDIT.ko.md)를 추가했습니다. 반복 조사·공급자 오류가 발생했으며 실제 자율 개발 전체 흐름은 아직 통과하지 못했습니다. 아래의 가짜 모델 통합 성공과 구분해야 합니다.
